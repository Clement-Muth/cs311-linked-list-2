...
{
private:
    Node *_front; // pointer to the _front node
    Node *_rear;  // pointer to the _rear node
    int _count;   // the number of nodes in the list
...
public:
     ...
     * The valid range of pos is 0 to _count-1. pos = 0 is the first node, and pos = _count-1 is the last node.
    ...
    /**
     * @brief Insert a value at a specified position in the list. The valid pos is in the range of 0 to _count.
     * The value will be inserted before the node at the specified position. if pos = 0, the value will be inserted
     * at the _front of the list. if pos = _count, the value will be inserted at the _rear of the list.
